...
const problem_statement = [
  {
    problem: "Q1) Implement Insertion: Write a C program to insert a new node into a tree.",
    id: "1",
  },
  {
    problem: "Q2) Implement Deletion: Write a C program to delete a node from a tree.",
    id: "2",
  },
  {
    problem: "Q3) Implement Height Calculation: Write a C program to calculate the height of a tree.",
    id: "3",
  },
  {
    problem: "Q4) Implement Depth-First Search (DFS): Write a C program to perform Depth-First Search traversal (pre-order, in-order, post-order) on a tree.",
    id: "4",
  },
  {
    problem: "Q5) Implement Breadth-First Search (BFS): Write a C program to perform Breadth-First Search traversal on a tree.",
    id: "5",
  },
  {
    problem: "Q6) Check if Balanced: Write a C program to check if a tree is balanced (the heights of the two subtrees of any node never differ by more than 1).",
    id: "6",
  },
        ...
        <div className="flex justify-center items-center p-6">
          <Tabs defaultValue="Tree" className="w-auto">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="Tree" className="">
                Tree
              </TabsTrigger>
